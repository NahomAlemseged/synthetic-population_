...
def preprocess(df):
    ...
    cat_cols = [
        ...
        'RACE', 'ETHNICITY', 'ADMIT_WEEKDAY', 'PAT_AGE','APR_MDC','APR_DRG'
    ]
...
def main_gen(args):
    ...
    df_train = extract_icd3(df_train)
    df_test = extract_icd3(df_test)
    ...
    if 'ICD3' not in df_new.columns:
        raise ValueError("ICD3 missing")
    ...
    # Save output
    # --------------------------
    output_file = output_path / "synthetic_inpatient_reverse_icd3.csv"
